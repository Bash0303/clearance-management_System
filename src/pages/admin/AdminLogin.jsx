...
const AdminLogin = () => {
  ...
  const handleChange = (e) => {
    ...
    // Do not trim password field if you want spaces to be valid (optional)
  ...
  const validate = () => {
    ...
    if (!formData.email.match(/^[^\s@]+@kwara\.poly\.edu\.ng$/i)) {
      newErrors.email = 'Valid institutional email required';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use window.location to ensure complete reload
              ...
              <div>
                ...
                <div className="relative mt-1 rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    placeholder="admin@kwara.poly.edu.ng"
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 text-gray-500 bg-white">Don't have an admin account?</span>
                </div>
              </div>
              <div className="mt-6">
                <button
