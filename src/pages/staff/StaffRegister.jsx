...
import { FiUser, FiMail, FiLock, FiPhone, FiKey, FiChevronDown, FiBook } from 'react-icons/fi';
        ...
        const fetchDepartments = async () => {
            try {
                ...
                if (data.success && data.departments) {
                    ...
                    throw new Error(data.message || 'Invalid departments data');
                }
            } catch (error) {
                        ...
                        <form className="space-y-6" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            disabled={isLoadingDepts || deptError}
                                            className={`block w-full pl-10 pr-10 py-2.5 text-base border ${errors.department ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                                    ...
                                    {deptError && !errors.department && (
                                        <p className="mt-1 text-sm text-red-600">Department list: {deptError}</p>
                                    )}
                                </div>
                            ...
                            <div className="pt-2">
                                <button
                                    ...
                                    className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-900 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                                >
                                    {isSubmitting ? (
                                        <>
